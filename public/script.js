...
function display() {
  let sockets = JSON.parse(get('https://gate.kitsuforyou.repl.co/sockets'))
...
function image(id, method) {
  let url = `https://gate.kitsuforyou.repl.co/do/${method}/${id}`
...
function kill(id) {
  let url = `https://gate.kitsuforyou.repl.co/do/kill/${id}`
